...
def word2input(texts,vocab_file,max_len):
    ...
    #tokenizer = RobertaTokenizer(vocab_file="/root/autodl-tmp/domain_model/pretrained_model/roberta/vocab.json", merges_file="/root/autodl-tmp/domain_model/pretrained_model/roberta/merges.txt")
    token_ids =[]
